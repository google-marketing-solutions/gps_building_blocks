...
class GoogleCloudStorageToGoogleAnalyticsInitiatorOperator(
  ...
  def __init__(self, *args,
               gcs_bucket: Text,
               gcs_prefix: Text,
               gcs_content_type: gcs_hook.BlobContentTypes = (gcs_hook.
                                                              BlobContentTypes.
                                                              JSON),
               ga_tracking_id: Text,
    ...
    self.ga_hook = ga_hook.GoogleAnalyticsHook(
        ...
        dry_run=ga_dry_run)
    super(GoogleCloudStorageToGoogleAnalyticsInitiatorOperator, self).__init__(
